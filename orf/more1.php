...
<head>
	...
	<title>Product id = <?php echo $pid ?></title>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark ">
	...
	echo  "           <h3 class='card-title text-capitalize'>$typeofad</h3>";
	...
	<footer>
        <div class="footer">
            <div class="column">
                <a class="linkok" href="https://www.facebook.com/profil.php?id=100078933752322"><i class="fa fa-facebook"></i></a>
