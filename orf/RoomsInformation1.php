        ...
        <?php
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                try {
                    ...
                    $sql = "INSERT INTO `houseprofile` (`S_No`,`uname`, `fullname`, `email`, `address`, `phone`,`Rentprice`, `typeofad`, `road`, `floor`, `furnish`, `bathroom`, `kitchen`, `zip`,`about`, `images`) VALUES (NULL,`$uname`, '$fname', '$email', '$address', '$phone',$rent, '$typeofad', '$road', '$floor', '$furnish', '$bathroom', '$kitchen', '$zip','$about','$image')";
                    ...
                    echo "<div class='alert alert-warning bg-red alert-dismissible fade show' role='alert'>
                    <strong>Ohh no!!</strong> Something went wrong while uploading your data to the server .<br>Please try again
            ...
            <div class="form-control-file ">
                ...
                <div class="form-control-file">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" name="rent" class="form-control" placeholder="Rent Price.." required>
               ...
               <br>
                    ...
                    <div class="form-group row-cols-1 border-warning">
                        ...
                        &nbsp;&nbsp;&nbsp;
                        <input type="file" name="image" class="text-danger font-italic">
                    </div>
