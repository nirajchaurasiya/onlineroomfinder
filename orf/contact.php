...
<body>
    ...
    <div class="container my-4">
        <h2>Contact Us</h2>
        <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" name="form1" id="form1" required>
            <p>
            ...
            <p>
                ...
                <input type="text" name="student" class="form-control" id="student" placeholder="eg: yes or no" required>
            </p>
            <p>
                <label class="label" for="about">Tell us about your self</label>
                <textarea class="form-control" id="about" name="about" rows="3" placeholder="How can we help you ?" required></textarea>


            </p>
            <p>
                <label class="label" for="about">Elaborate your concern</label>
                <textarea name="concern" class="form-control" id="concern" rows="3" placeholder="How can we help you ?" required></textarea>
...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if (!$result) {
        die("Looks like our server is down. try again later.");
    }
    else {
        echo "<script>alert('We have received your message . We will contact you soon');</script>";
    }
}
